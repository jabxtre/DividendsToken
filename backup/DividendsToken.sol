...
contract TVDS10 is Context, IERC20, Ownable, ReentrancyGuard {
	...
	address CHARITY_ADDRESS = 0x8cc875277a64D9ED35a530d4afe46831365135f6; // NEEDS TO CHANGE
...
// 	uint256 private _feeRemoveDuration = 30 * 24 * 3600;
	...
	// remove fee test after 5 mins 
    uint256 private _feeRemoveDuration = 1 * 24 * 3600;
// 	string private _name = "DividendsToken";
// 	string private _symbol = "DIVS";

	string private _name = "TVDS10";
	string private _symbol = "TVDS10";
	...
	function excludeFromReward(address account) public onlyOwner {
		require(!EnumerableSet.contains(_isExcludedFromReward, account), "Account is already excluded");
	...
	function _transfer(
        ...
        // Set the first deposit date of the receiver
